...
function sassLoader(content) {
    ...
    const loaderOptions = utils.getOptions(this);
    const themeMapper = loaderOptions.themeMapper ? loaderOptions.themeMapper : x => x;

    const resourcePath = themeMapper(this.resourcePath);
